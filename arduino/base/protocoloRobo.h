...
typedef enum tipoMensagem {
  Ack, EscrevePino, EscrevePwm, MotorDirecaoPwm, MotorDirecaoVelocidade, MotorDirecaoDistancia, EscreveConfiguracao, Ping, Echo, softwareReset, LeituraPino, LeituraAnalogica, LeituraVelocidade, LeituraEncoder, LeituraConfiguracao
} tipomensagem;
